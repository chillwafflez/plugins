---
name: log-draw
description: Log a drawing session with duration in minutes
...
Log a drawing session to the Activity Log database.

1. Parse the duration in minutes from the first argument. If no argument provided, ask the user how long they drew.
...
4. Create a new page in the database with:
   - Title: "Drawing - {today's date formatted as Mon D, YYYY}"
